...
function model_Dijkstra(A::Matrix{Char}, start::Vector{Int64}, final::Vector{Int64} )
...
function model_Astar(A::Matrix{Char}, start::Vector{Int64}, final::Vector{Int64} )
...
function Astar(nom_fichier,start::Vector{Int64},final::Vector{Int64})
...
function Dijkstra(nom_fichier,start::Vector{Int64},final::Vector{Int64})
